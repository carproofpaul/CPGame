            ...
            <ScrollView>
                <View style={styles.inner}>
                    ...
                    <View style={{justifyContent: 'flex-start', marginBottom: 15}}>
                        ...
                        <Text style={{fontWeight: 'bold', marginBottom: 10}}>Police Reported Accidents</Text>
                        <Text style={{textAlign: 'left', marginBottom: 10}}>Accidents reported by police facilities are listed below.</Text>
                        <ScrollView horizontal={true}>
                            <Table borderStyle={{borderWidth: 0}}>
                                <Row data={this.police.tableHead}  style={styles.head} textStyle={styles.text}/>
                                <Divider style={{backgroundColor: '#000'}} />
                                <Rows data={this.police.tableData}  textStyle={styles.text}/>
                                <Divider style={{backgroundColor: '#000'}} />
                            </Table>
                        </ScrollView>
                        { /* Accident/Damage Estimates */ }
                        <Text style={{fontWeight: 'bold', marginBottom: 10, marginTop: 10}}>Accident/Damage Estimates</Text>
                        <Text style={{textAlign: 'left', marginBottom: 10}}>
                        ...
                        <ScrollView horizontal={true}>
                            <Table borderStyle={{borderWidth: 0}}>
                                <Row data={this.accidents.tableHead}  style={styles.head} textStyle={styles.text}/>
                                <Divider style={{backgroundColor: '#000'}} />
                                <Rows data={this.accidents.tableData}  textStyle={styles.text}/>
                                <Divider style={{backgroundColor: '#000'}} />
                            </Table>
                        </ScrollView>
                        { /* Insurance Claims */ }
                        <Text style={{fontWeight: 'bold', marginBottom: 10, marginTop: 10}}>Insurance Claims</Text>
                        <Text style={{textAlign: 'left', marginBottom: 10}}>
                        ...
                        <ScrollView horizontal={true}>
                            <Table borderStyle={{borderWidth: 0}}>
                                <Row data={this.insurance.tableHead}  style={styles.head} textStyle={styles.text}/>
                                <Divider style={{backgroundColor: '#000'}} />
                                <Rows data={this.insurance.tableData}  textStyle={styles.text}/>
                                <Divider style={{backgroundColor: '#000'}} />
                            </Table>
                        </ScrollView>
                        { /* Other Damage Records */ }
                        <Text style={{fontWeight: 'bold', marginBottom: 10, marginTop: 10}}>Other Damage Records</Text>
                        <Text style={{textAlign: 'left', marginBottom: 10}}>

...
export default class StolenStatus extends PureComponent {
  constructor(props) {
    super(props);
    this.state = {
  ...
  render() {
    if(this.props.data == false) component = <Text style={{fontStyle: 'italic', textAlign: 'center'}}>No History Available</Text>
    else component = null
